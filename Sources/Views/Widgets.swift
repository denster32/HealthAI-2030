    ...
    var body: some View {
        VStack(spacing: 8) {
            HStack {
                ...
                Text(LocalizedStringKey("Cardiac"))
                    .font(.caption)
                    .fontWeight(.medium)
                    .dynamicTypeSize(.xSmall ... .accessibility3)
                    .accessibilityLabel(Text(LocalizedStringKey("Cardiac Health Widget Title")))
                Spacer()
            }
            ...
            VStack(spacing: 4) {
                Text("\(Int(entry.heartRate))")
                    ...
                    .fontWeight(.bold)
                    .foregroundColor(.red)
                    .accessibilityLabel(Text(LocalizedStringKey("Heart Rate")))
                    .accessibilityValue("\(Int(entry.heartRate)) BPM")
            ...
            HStack {
                Label("\(Int(entry.hrv))ms", systemImage: "waveform.path.ecg")
                    ...
                    .accessibilityLabel(Text(LocalizedStringKey("HRV")))
                    .accessibilityValue("\(Int(entry.hrv)) ms")
                ...
                Text(entry.afibStatus.displayName)
                    ...
                    .accessibilityLabel(Text(LocalizedStringKey("AFib Status")))
                    .accessibilityValue(Text(entry.afibStatus.displayName))
            }
        }
        .padding()
        .background(Color(.systemBackground))
        .accessibilityElement(children: .combine)
        .accessibilityLabel(Text(LocalizedStringKey("Cardiac Health Widget")))
    }
        ...
        VStack(spacing: 8) {
            HStack {
                ...
                Text("Respiratory")
                    .font(.caption)
                    .fontWeight(.medium)
                    .accessibilityLabel(Text(LocalizedStringKey("Respiratory Health Widget Title")))
                Spacer()
            }
            ...
            VStack(spacing: 4) {
                Text("\(String(format: "%.1f", entry.oxygenSaturation))")
                    ...
                    .accessibilityLabel(Text(LocalizedStringKey("Oxygen Saturation")))
                    .accessibilityValue("\(String(format: "%.1f", entry.oxygenSaturation))% O2")
                Text("% O2")
                    .font(.caption2)
                    .foregroundColor(.secondary)
                    .accessibilityHidden(true)
            ...
            HStack {
                Label("\(String(format: "%.1f", entry.respiratoryRate))", systemImage: "lungs")
                    .font(.caption2)
                    .foregroundColor(.blue)
                    .accessibilityLabel(Text(LocalizedStringKey("Respiratory Rate")))
                    .accessibilityValue("\(String(format: "%.1f", entry.respiratoryRate)) breaths per minute")
                ...
                Text(entry.pattern.displayName)
                    ...
                    .accessibilityLabel(Text(LocalizedStringKey("Breathing Pattern")))
                    .accessibilityValue(Text(entry.pattern.displayName))
            }
        }
        .padding()
        .background(Color(.systemBackground))
        .accessibilityElement(children: .combine)
        .accessibilityLabel(Text(LocalizedStringKey("Respiratory Health Widget")))
    }
        ...
        VStack(spacing: 8) {
            HStack {
                ...
                Text("Sleep")
                    .font(.caption)
                    .fontWeight(.medium)
                    .accessibilityLabel(Text(LocalizedStringKey("Sleep Optimization Widget Title")))
                Spacer()
            ...
            VStack(spacing: 4) {
                Text("\(Int(entry.quality * 100))")
                    ...
                    .fontWeight(.bold)
                    .foregroundColor(.indigo)
                    .accessibilityLabel(Text(LocalizedStringKey("Sleep Quality")))
                    .accessibilityValue("\(Int(entry.quality * 100))%")
                Text("Quality")
                    .font(.caption2)
                    .foregroundColor(.secondary)
                    .accessibilityHidden(true)
            ...
            Text(entry.stage.displayName)
                ...
                .fontWeight(.medium)
                .foregroundColor(.secondary)
                .accessibilityLabel(Text(LocalizedStringKey("Sleep Stage")))
                .accessibilityValue(Text(entry.stage.displayName))
        }
        .padding()
        .background(Color(.systemBackground))
        .accessibilityElement(children: .combine)
        .accessibilityLabel(Text(LocalizedStringKey("Sleep Optimization Widget")))
    }
}
            ...
            VStack(alignment: .trailing, spacing: 12) {
                HStack {
                    ...
                    Text("\(String(format: "%.1f", entry.temperature))°C")
                        .font(.subheadline)
                        .fontWeight(.medium)
                        .accessibilityLabel(Text(LocalizedStringKey("Temperature")))
                        .accessibilityValue("\(String(format: "%.1f", entry.temperature)) degrees Celsius")
                }
                ...
                HStack {
                    ...
                    Text("\(Int(entry.humidity))%")
                        .font(.subheadline)
                        .fontWeight(.medium)
                        .accessibilityLabel(Text(LocalizedStringKey("Humidity")))
                        .accessibilityValue("\(Int(entry.humidity))%")
                }
            }
        }
        .padding()
