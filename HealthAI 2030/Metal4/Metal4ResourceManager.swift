...
class Metal4ResourceManager: NSObject, ObservableObject {
    ...
    private func startResourceMonitoring() {
        resourceMonitorTimer = Timer.scheduledTimer(withTimeInterval: 1.0, repeats: true) { _ in
...
class PipelineStatePool {
    ...
    func getPipelineState(for functionName: String) -> MTLComputePipelineState? { return nil }
    func cachePipelineState(_ pipelineState: MTLComputePipelineState, for functionName: String) {}
    func getCachedCount() -> Int { return 0 }
}
