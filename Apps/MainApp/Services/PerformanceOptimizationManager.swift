...
class PerformanceOptimizationManager: NSObject, ObservableObject {
    ...
    @Published var optimizationStatus: OptimizationStatus = .monitoring
    ...
    private func updateOptimizationStatus(_ status: OptimizationStatus) {
        DispatchQueue.main.async {
...
enum OptimizationStatus: Equatable {
    ...
    static func == (lhs: OptimizationStatus, rhs: OptimizationStatus) -> Bool {
        switch (lhs, rhs) {
...
struct PerformanceOverviewSection: View {
    @ObservedObject var performanceManager: PerformanceOptimizationManager
