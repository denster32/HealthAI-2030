...
// Remove or comment out top-level test code and shell commands
/*
...
// Remove stray enum case at top level
// case .iPhoneSE: sampleRate = 44100 partials = 384 frameSize = 768
// This should be inside a switch or enum, not at the top level.
