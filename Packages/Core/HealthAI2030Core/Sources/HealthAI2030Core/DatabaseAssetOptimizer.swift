...
public class DatabaseAssetOptimizer: ObservableObject {
    ...
    @Published public var optimizationStatus = DatabaseAssetOptimizationStatus()
    @Published public var recommendations: [OptimizationRecommendation] = []
    @Published public var isOptimizing = false
    
    // MARK: - Private Properties
    private let logger = os.Logger(subsystem: "com.healthai.optimization", category: "database-asset")
...
/// Database asset optimization status
@available(iOS 18.0, macOS 15.0, *)
public struct DatabaseAssetOptimizationStatus: Codable {
