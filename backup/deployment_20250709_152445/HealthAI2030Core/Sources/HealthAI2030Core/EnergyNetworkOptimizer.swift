...
public class EnergyNetworkOptimizer: ObservableObject {
    ...
    private func updateOptimizationStatus() {
        let energySeverity = energyMetrics.batteryDrainRate > energyThreshold ? OptimizationSeverity.critical : .normal
        let networkSeverity = networkMetrics.dataUsage > networkThreshold ? OptimizationSeverity.warning : .normal
