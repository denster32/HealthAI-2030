...
public struct DataIntegrityManager {
...
// Example extension for a hypothetical model
extension HealthDataEntry {
    var dataChecksum: String {
        DataIntegrityManager.shared.computeChecksum(self)
    }
    
    func validateIntegrity() -> Bool {
        // Assuming you have a way to store and retrieve the original checksum
